...
//     if (index === 1) {
//       return 'transform translate-y-8 w-64 h-80'; // Enlarge and slightly lower the second card
//     }
//     return 'w-64 h-80'; // Default size for other cards
//   };

//   return (
//     <>
//       <section className="mx-auto w-3/4 py-16 mb-8">
...
//               <div
//                 key={upload.id}
//                 className={`flex flex-col items-center bg-white shadow-lg rounded-lg py-6 ${getCardStyles(
//                   index
//                 )} m-2`}
//               >
