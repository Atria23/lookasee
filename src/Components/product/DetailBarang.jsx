...
//               <div className="drop-shadow-xl border w-full md:w-1/3 h-1/3 rounded-lg bg-white">
//                 <img
...
//                 />
//               </div>
//               <div className="flex-1 md:ml-6 h-svh pb-44 overflow-y-auto scrollbar-hidden">
  ...
  return (
    <>
      ...
      <button
        ...
        className="flex items-center justify-center text-white bg-utama hover:bg-blue-400 font-medium rounded-lg text-sm px-2 py-2 sm:px-5 sm:py-2.5"
      >
