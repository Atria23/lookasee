            ...
            <div className="flex flex-col lg:flex-row bg-blue-100 py-8 px-6 rounded-lg">
              ...
              <div className="flex flex-col lg:w-2/3 lg:pl-10">
                <div className="mb-4">
                  ...
                  <p className="text-md break-word">{userData.name}</p>
                </div>
                <div className="mb-4">
                  <label className="block text-gray-700 font-bold">Email:</label>
                  <p className="text-md break-word">{userData.email}</p>
                </div>
                <div className="mb-4">
                  <label className="block text-gray-700 font-bold">Telepon:</label>
                  <p className="text-md break-word">{userData.phoneNumber}</p>
                </div>
                <div className="mb-4">
                  <label className="block text-gray-700 font-bold">Alamat:</label>
                  <p className="text-md break-word">{userData.address}</p>
                </div>
                <button
            ...
            <div className="bg-gray-300 ">
              <div className="w-64 h-64 relative">
                <label
                  ...
                  className="h-full w-full border-2 border-gray-300 border-dashed rounded-full cursor-pointer bg-gray-50 flex items-center justify-center"
                >
                  {previewUrl ? (
